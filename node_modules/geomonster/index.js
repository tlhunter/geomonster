var GeoMonster = function() {
	...
	var monster_types = {
		0: { name: 'Special A', wild: false, begin_level: 3 },
		1: { name: 'Special B', wild: false, begin_level: 3 },
		2: { name: 'Special C', wild: false, begin_level: 3 },

		3: { name: 'Raccoon', wild: true, begin_level: 1 },
		4: { name: 'Salamander', wild: true, begin_level: 1 },
		5: { name: 'Cobra', wild: true, begin_level: 1 },
		6: { name: 'Bear', wild: true, begin_level: 2 },
		7: { name: 'Tiger', wild: true, begin_level: 2 },
		8: { name: 'Jiraffe', wild: true, begin_level: 3 },
		9: { name: 'Elephant', wild: true, begin_level: 4 },
	};
